package io.lazyegg.db.aspect;

import io.lazyegg.db.DynamicContextHolder;
import io.lazyegg.db.annotation.DataSource;
...
public class DataSourceAspect {
    ...
    @Pointcut("@annotation(io.lazyegg.db.annotation.DataSource) " +
            "|| @within(io.lazyegg.db.annotation.DataSource)")
